...
@interface MADAttentionViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation MADAttentionViewController
...
- (void)viewDidLoad {
    ...
    _array =@[@"小明",@"Kitty",@"狗蛋",@"我",@"加盟",@"哦片",@"更好",@"批评",@"成功",@"举",@"每年可怜人",@"肌肉",@"花卉业",@"笑呵呵"];
    _tableView =[[UITableView alloc]initWithFrame:CGRectMake(0, 0, self.view.size.width, self.view.size.height-54)];
    _tableView.delegate =self;
    _tableView.dataSource =self;
    [self.view addSubview:_tableView];
     [self sequence];
    [_tableView registerClass:[MADFriendsTableViewCell class] forCellReuseIdentifier:@"cell1"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MADFriendsTableViewCell *cell =[tableView dequeueReusableCellWithIdentifier:@"cell1" forIndexPath:indexPath];
