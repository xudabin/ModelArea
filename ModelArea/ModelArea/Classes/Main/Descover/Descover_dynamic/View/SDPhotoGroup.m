...
//    int mm=0;
//    if (_photoItemArray.count>6) {
//        mm=6;
//    }else
//    {
//        mm=photoItemArray.count;
//    }
//    for (int i=0; i<mm; i++) {
//        [array addObject:photoItemArray[i]];
//    }
    [_photoItemArray enumerateObjectsUsingBlock:^(SDPhotoItem *obj, NSUInteger idx, BOOL *stop) {
...
//    self.frame =CGRectMake(10, 10, 280, 100);
}
